...
namespace InsureYouAI.Controllers
{
    public class DefaultController : Controller
    {
        ...
        public async Task<IActionResult> SendMessage(Message message)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("InsureYouAI Admin", "tourifyx0@gmail.com");
            ...
            client2.Authenticate("tourifyx0@gmail.com", "kfih czfz qyri pcpp");
